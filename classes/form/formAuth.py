...
class formAuth(simpledialog.Dialog):
    ...
    def body(self, master):
        """ Main part of the dialog (password input) """
        self.geometry("300x120")  # Fixed size
        self.resizable(False, False)  # Disable resizing
        self.overrideredirect(True)  # Disable maximize/minimize
        self.attributes("-topmost", True)  # Display on top
        ...
        tk.Label(self.frame_border, text="Please enter your password:").pack(pady=10)
    ...
    def buttonbox(self):
        ...
        _btn_cancel = tk.Button(_frame_buttunbox, text="Cancel", width=10, command=self.cancel)
